...
public class ImageDeleteScheduling {
	...
	public void test() {
		...
		// C:\springworkspace\07_Framework\boardProject_new\src\main\webapp\resources\images
...
//		}
		...
		if( !serverImageList.isEmpty() ) {
			...
			for(File server : serverImageList) {
				...
				//server.toString();
				// C:\springworkspace\07_Framework\boardProject_new\src\main\webapp\resources\images\이미지명
